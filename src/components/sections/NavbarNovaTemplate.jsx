        ...
        <div className="container mx-auto flex items-center m-auto max-w-[1215px] h-full w-[90%] justify-between py-2">
          <div
            className={`flex flex-col z-20 relative  ${
              isScrolled
                ? "w-[30%] h-[20px] phone2:w-[30%] phone2:h-[30px] tablet1:h-[50px] tablet1:w-[20%] desktop1:w-[10%] desktop1:h-[50px] desktop2:w-[14%] transition-all duration-700"
                : "w-[40%] h-[40px] phone2:py-3 phone2:w-[50%] phone2:h-[80px] tablet1:h-[120px] tablet1:w-[40%] tablet2:w-[30%] desktop1:w-[20%] desktop1:h-[110px] desktop2:w-[18%] transition-all duration-700"
            }`}
          >
            <a
